...
use Hash;
use Auth;
use \Spatie\Permission\Models\Permission  as ModeloPrincipal;
...
class PermissionController extends Controller
{
    ...
    public function listado(){
        ...
        $records = ModeloPrincipal::where('active',true)->get()->groupBy('modulo')->toArray();
    ...
    public function index(){
        ...
        $records = ModeloPrincipal::get()->groupBy('modulo')->toArray();
