...
<div>
  ...
  <div class="d-flex flex-column-fluid">
    ...
    <form @submit="ActualizarForm" method="POST" enctype="multipart/form-data" class="form" id="formulario">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" id="selectpicker_globos" required data-live-search="true" v-model="form.globo_id">
                  <option value="" selected disabled>Seleccione</option>
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group pb-1 mb-1">
                <label for="parte_mateo">Parte METEO</label>    
                  <a :href="form.parte_mateo" v-if="form.parte_mateo!=null" target="_blank" class="ml-2 badge badge-primary badge-pill" title="Descargar Parte METEO"> Descargar</a>
                  <span v-else class="ml-2 badge badge-danger badge-pill"> Sin Doc. </span>
               
                  <b-form-file 
                    id="parte_mateo"
                    ref="form_parte_mateo"
                    placeholder="Buscar PARTE MATEO..."
                    drop-placeholder="Suelta el archivo aquí..."
                  ></b-form-file>
              </div> 
              <div v-if="can('flights-update')">
                  ...
                  <div v-else>                      
                    ...
                    <span v-else-if="load_meteoblue=='cargado'">
                      <a :href="'/uploads/'+parte_meteo_meteoblue" target="_blank" class="btn btn-sm btn-success">
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group">
                ...
                <select class="form-control" multiple id="selectpicker_soguillas" required data-live-search="true" v-model="form.soguillas">
                  <option value="" selected disabled>Seleccione</option>
                  ...
                  <div class="card mb-5">
                    ...
                    <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12 mb-15 text-center"  v-if="can('flights-update')"> 
                                <a
                            ...
                            <div class="col-md-4 mb-3">
                              <div class="form-group">
                                ...
                                <a :href="form.tabla_carga" v-if="form.tabla_carga!=null" target="_blank" class="ml-2 badge badge-primary badge-pill" title="Descargar Tabla de carga"> Descargar</a>
                                <span v-else class="ml-2 badge badge-danger badge-pill"> Sin Doc. </span>
                                  <b-form-file 
                                    id="tabla_carga"
                            ...
                            <div class="col-md-2 mb-3">
                              <div class="form-group">
                                ...
                                <!-- <input :value="form.tabla_carga_maxima" id="tabla_carga_maxima" v-numero type="text" class="form-control"> -->
                                <input v-model="form.tabla_carga_maxima" type="text" class="form-control">
          ...
          <div class="row">
            <div class="col-md-12">              
              ...
              <div class="card gutter-b">
                ...
                <header_card icon="" titulo="Detalles del vuelo Realizado" tipo="sub"></header_card>
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <div class="form-group">
                          ...
                          <input v-model="form.lugar_despegue" id="lugar_despegue" type="text" class="form-control">
                        </div> 
                      </div> 
                      <div class="col-md-3 mb-3">
                        <div class="form-group">
                          <label for="fecha_despegue">Fecha Despegue</label>
                          <input v-model="form.fecha_despegue" id="fecha_despegue" type="date" class="form-control">
                        </div> 
                      </div> 
                      <div class="col-md-3 mb-3">
                        <div class="form-group">
                          <label for="hora_despegue">Hora Despegue</label>
                          <input v-model="form.hora_despegue" id="hora_despegue" type="time" class="form-control">
                        </div> 
                      </div> 
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <div class="form-group">
                          ...
                          <input v-model="form.lugar_aterrizaje" id="lugar_aterrizaje" type="text" class="form-control">
                        </div> 
                      </div> 
                      <div class="col-md-3 mb-3">
                        <div class="form-group">
                          <label for="fecha_aterrizaje">Fecha Aterrizaje</label>
                          <input v-model="form.fecha_despegue" id="fecha_aterrizaje" type="date" class="form-control">
                        </div>
                      </div> 
                      <div class="col-md-3 mb-3">
                        <div class="form-group">
                          <label for="hora_aterrizaje">Hora Aterrizaje</label>
                          <input v-model="form.hora_aterrizaje" id="hora_aterrizaje" type="time" class="form-control">
                        </div> 
                      </div>   
                      <div class="col-md-3 mb-3">
                          <b-form-checkbox
          ...
          <div class="row">
            <div class="col-md-12">              
              ...
              <div class="card gutter-b">
                    ...
                    <header_card icon="" titulo="Horas del Vuelo del Globo" tipo="sub"></header_card>
                ...
                <div class="card-body">
                  ...
                  <b-collapse visible  id="collapse-2">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <div class="form-group">
                          <label for="horas_inicial_globo">Horas de vuelo del Globo al inicial el vuelo</label>
                          <input v-model="form.horas_inicial_globo" id="horas_inicial_globo" type="text" class="form-control">
                        </div> 
                      </div>  
                      <div class="col-md-6 mb-3">
                        <div class="form-group">
                          <label for="horas_final_globo">Horas de vuelo del Globo al finalizar el vuelo</label>
                          <input v-model="form.horas_final_globo" id="horas_final_globo" type="text" class="form-control">
                        </div> 
                      </div>    
                    </div>
...
<script>
    ...
    export default {
      ...
      props : ['id','dashboard'],
        ...
        mounted() {
          this.ValidarPermisos('flights-update');
          this.Buscar();
          this.BuscarGlobos();
          this.BuscarZonas();
          this.BuscarPilotos();
        ...
        methods: { 
         ...
         jeje() {
          ...
          ValidarCalculo(campo) {
            if(campo=='gas'){
              this.form.reserva = this.form.gas * 0.20;
            }
          },
          reset() {
         ...
         Buscar() { 
            ...
            axios.get(url).then(response=>{
                ...
                this.CargarZona(this.form.zona_id);
            }).catch(error => {
                this.errors = error.response.data
            });
        },
          ...
          DescargarMeteoblue() {
            ...
            var url = '/admin/descargar_meteoblue/'+this.form.zona_id;
                axios.get(url).then(response=>{
                    this.parte_meteo_meteoblue = response.data.records;   
          ...
          ActualizarForm(evt) {
            ...
            evt.preventDefault();
              ...
              formData.append('lugar_despegue', this.form.lugar_despegue);
              formData.append('fecha_despegue', this.form.fecha_despegue);
              formData.append('hora_despegue', this.form.hora_despegue);
              formData.append('lugar_aterrizaje', this.form.lugar_aterrizaje);
              formData.append('hora_aterrizaje', this.form.hora_aterrizaje);
              formData.append('cautivo', this.form.cautivo);
              ...
              formData.append('horas_inicial_globo', this.form.horas_inicial_globo);
              formData.append('horas_final_globo', this.form.horas_final_globo);
              ...
              formData.append('parte_meteo_meteoblue', this.parte_meteo_meteoblue);
              ...
              axios.post(url, formData,{
                headers: {
                  ...
                  if(!response.data.result){
                    this.$toastr.error('Ocurrio un error al actualizar vuelo', 'Error en Proceso...');       
                  }else{                
                  this.$toasted.success('Vuelo Actualizado Correctamente');              
                   this.reset();    
                  this.Buscar();
