      ...
      <div class="card card-custom mb-5">
          ...
          <div class="card-header flex-wrap border-0 pb-0 bg-light-danger">
            <h3 class="card-title w-100 d-flex justify-content-between">
              ...
              <router-link 
                to="/globos/cestas/crear"
                v-if="can('balloons_baskets-create')"
              class="btn btn-primary d-flex align-items-center"
            >
              <i class="flaticon-plus"></i> 
              <span class="d-none d-md-block"> Registrar Cesta </span>
              </router-link>
            </h3>
          </div> 
        ...
        <div class="card-body">
         ...
         <tabla-component :striped="true"
            ...
            :listado="records" 
            titulo="Cesta"
            :can_ver="can('balloons_baskets-read')"
            :can_editar="can('balloons_baskets-update')"
            :can_eliminar="can('balloons_baskets-delete')"   
...
<script>
    ...
    export default {
        ...
        methods: { 
         ...
         ButtonGo(data) {
            this.$router.push({
                path: '/globos/cestas/consultar/'+data.data.id
            });
          },    
            ...
            var registro = data.data;
             ...
             Swal.fire({
                ...
                if (result.value) {          
                    ...
                    var url = '/admin/globo_cestas/'+registro.id;
                    ...
                    axios.post(url,{
                      ...
                      if(!response.data.result){
                        ...
                        _this.$toasted.success('Cesta Eliminado Correctamente');
