      ...
      <div class="card card-custom mb-5">
          ...
          <div class="card-header flex-wrap border-0 pb-0 bg-light-danger">
            <h3 class="card-title w-100 d-flex justify-content-between">
              ...
              <router-link 
                to="/globos/botellas/crear"
                v-if="can('balloons_bottles-create')"
              class="btn btn-primary d-flex align-items-center"
            >
              <i class="flaticon-plus"></i> 
              <span class="d-none d-md-block"> Registrar Botella </span>
              </router-link>
            </h3>
          </div> 
        ...
        <div class="card-body">
         ...
         <tabla-component :striped="true"
            ...
            :listado="records" 
            titulo="Botella"
            :can_ver="can('balloons_bottles-read')"
            :can_editar="can('balloons_bottles-update')"
            :can_eliminar="can('balloons_bottles-delete')"   
...
<script>
    ...
    export default {
        ...
        methods: { 
         ...
         ButtonGo(data) {
            this.$router.push({
                path: '/globos/botellas/consultar/'+data.data.id
            });
          },    
            ...
            var registro = data.data;
             ...
             Swal.fire({
                ...
                if (result.value) {          
                    ...
                    var url = '/admin/globo_botellas/'+registro.id;
                    ...
                    axios.post(url,{
                      ...
                      if(!response.data.result){
                        ...
                        _this.$toasted.success('Botella Eliminado Correctamente');
